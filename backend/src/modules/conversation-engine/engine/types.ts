...
export interface WhatsAppSender {
  /**
   * `quotedWaMessageId` is optional and every existing caller omits it — the engine, the
   * workflows and the campaign sender have nothing to quote. Only the Inbox reply does.
   */
  sendText(args: {
    to: string;
    body: string;
